...
interface SieveAndMagnetOldPlantState {
...
const initialState: SieveAndMagnetOldPlantState = {
  completedCycles: [],
  pendingSync: [],
...
export const sieveAndMagnetOldPlantSlice = createSlice({
  name: 'sieveAndMagnetOldPlant',
  initialState,
  reducers: {
...
export const {
  ...
  setCurrentCycle,
  clearAllData,
} = sieveAndMagnetOldPlantSlice.actions;

export default sieveAndMagnetOldPlantSlice.reducer;
